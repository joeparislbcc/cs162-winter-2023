...
def main():
    ...
    instance_2.instance_attribute = "CS162"  # adds the instance_attribute
    print(instance_2.instance_attribute)
    instance_2.foobar = lambda: print("foobar")
    instance_2.foobar()
    ...
    del instance_2.instance_attribute
    del instance_2.foobar
    print()
    print()
    print("output of dir(instance_1):")
    print(dir(instance_1))
    ...
    print(instance_1)  # call print() function, pass in what it is to operate on
    instance_1.my_method("CS162")  # call MyClass.my_method() *ON* an instance of MyClass
